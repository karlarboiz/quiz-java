    ...
    return (
        ...
        className={quiz['user-card']}>
            <div className={quiz['user-card--header']}>
                ...
                <div className={quiz['user-card--header-user--details']}>
                <div className={quiz['username']}>{username}</div>
                <div className={quiz['register-date']}>Date Registered:</div>
                <div className={quiz['register-date']}> {convertedDate}</div>
                </div>
