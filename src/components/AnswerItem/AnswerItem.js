...
const AnswerItem = ({text,getAnswer,dataValue,index,variants})=>{
    ...
    return (
        <motion.li onClick={getAnswer} className={quiz['quiz-question__answer']} tabIndex={dataValue} variants={variants}>
            {showCheck}
            {text}
        </motion.li>
    )
